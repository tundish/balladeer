...
In the previous sections we saw how a few simple principles provide the framework for an extremely
...
Is that the right approach? Not if you want it to be fun, I shouldn't think.
...
It has to be there, otherwise no dead Emperor.
